...
export const getX64InstanceTypes = (instanceType: string): InstanceTypeInfo => {
  ...
  case x64Ec2InstanceType.R7I_XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7I, InstanceSize.XLARGE), hasInternalStorage: false };
  case x64Ec2InstanceType.R7I_2XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7I, InstanceSize.XLARGE2), hasInternalStorage: false };
  case x64Ec2InstanceType.R7I_4XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7I, InstanceSize.XLARGE4), hasInternalStorage: false };
  case x64Ec2InstanceType.R7I_8XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7I, InstanceSize.XLARGE8), hasInternalStorage: false };
  default:
...
export const getArm64InstanceTypes = (instanceType: string): InstanceTypeInfo => {
  ...
  case arm64Ec2InstanceType.R7G_XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7G, InstanceSize.XLARGE), hasInternalStorage: false };
  case arm64Ec2InstanceType.R7G_2XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7G, InstanceSize.XLARGE2), hasInternalStorage: false };
  case arm64Ec2InstanceType.R7G_4XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7G, InstanceSize.XLARGE4), hasInternalStorage: false };
  case arm64Ec2InstanceType.R7G_8XLARGE:
    return { instance: InstanceType.of(InstanceClass.R7G, InstanceSize.XLARGE8), hasInternalStorage: false };
