...
| heapSizeInGb                  | Optional    | number  | Explicit heap size (in GB) applied to data/single nodes. Mutually exclusive with `use50PercentHeap`. e.g., `--context heapSizeInGb=16`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| enableGrpc                    | Optional    | boolean | Enable gRPC endpoints. e.g., `--context enableGrpc=true`. Defaults to false.                                                                                                                                                                                                                                                                     |
| mapGrpcPortTo                 | Optional    | integer | Load balancer port number to map to gRPC endpoint. e.g., `--context mapGrpcPortTo=9443`. Defaults to 9443 when gRPC is enabled.                                                                                                                                                                                                                                                                    |
